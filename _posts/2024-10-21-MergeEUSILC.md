...
For many research projects, however, we need a merged version of these files. We may want to combine household-level and individual-level information or pool information across multiple available years. I found a package for R called r.eusilc, but it does not seem to have been maintained for eight years. I have not tried it, and instead decided to build my own program.
...
Another excellent resource for getting started with the data is this collection of one of my former employers. 
